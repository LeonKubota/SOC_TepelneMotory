...
{Vyrenderované sekvence snímků jsem přidal do časové osy \code{Blenderu}, na konec videa jsem přidal skutečné záběry.}\odst
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/images/osaZvuk.png}
