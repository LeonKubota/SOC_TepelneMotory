...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.25]{images/NodeUkazka.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[scale=.2]{images/1.9TDImodelUkazka.png}
    ...
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[scale=.2]{images/1.9TDImodelMaterialy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.35]{images/geometryNodeUkazka.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.35]{images/cary.png}
...
\begin{figure}[H]
    \begin{minipage}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=.11]{images/1.9TDI1.png}\\
        {Zážeh ve čtvrtém válci}
        \vspace{4ex}
    \end{minipage}
    \begin{minipage}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=.11]{images/1.9TDI2.png}\\
        {Zážeh ve třetím válci}
        \vspace{4ex}
    \end{minipage}
    \begin{minipage}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=.11]{images/1.9TDI3.png}\\
        {Zážeh v prvním válci}
        \vspace{4ex}
    \end{minipage}
    \begin{minipage}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=.11]{images/1.9TDI4.png}\\
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.2]{images/ParniStrojRender.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=2]{images/DoosanSkodaPowerMTD50.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.2]{images/ParniTurbinaRender.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=.2]{images/Skoda1000MBPredek.jpg}
        \caption{Průřez}
        \label{obr:1000MBvykresyPrurez}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=.2]{images/Skoda1000MBBok.jpg}
        \caption{Bok}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/1000MBRender.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=.3]{images/1.9TDICrossSection.png}
        \caption{Průřez}
        \label{obr:1.9TDIvykresyPrurez}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=.3]{images/1.9TDILongitudinalSection.png}
        \caption{Bok}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.2]{images/1.9TDI3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.3]{images/motor175.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.6]{images/CZ175Render.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.5]{images/aim-9-sidewinder.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{images/AIM9Render.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.2]{images/RocketdyneJ2vykres.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.6]{images/J2Render.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.3]{images/TJ100Vykres.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{images/TJ100Render.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=.4]{images/CFM56vykres1.png}
        \caption{Výkres motoru CFM56}
        \label{obr:CFM56vykres1}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=.3]{images/CFM56vykres2.png}
        \caption{Výkres motoru CFM56}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/CFM56Render.png}
